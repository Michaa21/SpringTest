...
public interface StudentApi {
    ...
    default ResponseEntity<StudentResponse> createStudent(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"name\" : \"name\", \"id\" : 0, \"lessons\" : [ { \"id\" : 6, \"title\" : \"title\" }, { \"id\" : 6, \"title\" : \"title\" } ] }";
    ...
    default ResponseEntity<StudentResponse> getStudentById(
        @Parameter(name = "id", description = "", required = true, in = ParameterIn.PATH) @PathVariable("id") Long id
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
    ...
    default ResponseEntity<StudentResponse> updateStudent(
        @Parameter(name = "id", description = "", required = true, in = ParameterIn.PATH) @PathVariable("id") Long id,
        @Parameter(name = "StudentCreateRequest", description = "", required = true) @Valid @RequestBody StudentCreateRequest studentCreateRequest
    ) {
        getRequest().ifPresent(request -> {
